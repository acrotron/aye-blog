...
I just started thinking back and reminiscing on how it all started (not that long ago: repository creation was in the beginning of September) – and decided to put it in writing. This is a walk down memory lane to the very beginning.
...
The main problem with that of course is the catastrophic disaster when LLM does screw up and you loose all that you worked so hard on.
